...
class CaptioningSolver(object):
    ...
    def train(self):
        ...
        # for i in range(0, image_idxs.shape[0]):
        #     print(image_idxs[i])
        ...
        with tf.Session(config=config) as sess:
            ...
            for e in range(self.n_epochs):
                ...
                # for i, j in enumerate(image_idxs):
                #     if (j == 0):
                #         print(i, j)
                #         print("")
                ...
                #         print(i)
                #         print(captions[i])
                #         print(decode_captions(captions[i], self.model.idx_to_word))
                #         print("")

                # print("========================================================")

                # for i in range(1, len(image_idxs)):
                #     if (image_idxs[i] == 1):
                #         print(i)
                #         print(captions[i])
                #         print(decode_captions(captions[i], self.model.idx_to_word))
                ...
                # for i in range(2, len(image_idxs)):
                #     if (image_idxs[i] == 2):
                #         print(i)
                #         print(captions[i])
                #         print(decode_captions(captions[i], self.model.idx_to_word))
                ...
                # for i in range(3, len(image_idxs)):
                #     if (image_idxs[i] == 3):
                #         print(i)
                #         print(captions[i])
                #         print(decode_captions(captions[i], self.model.idx_to_word))
                ...
                for i in range(n_iters_per_epoch):
                    ...
                    # print(features[image_idxs_batch[0]])
                    # print("")
